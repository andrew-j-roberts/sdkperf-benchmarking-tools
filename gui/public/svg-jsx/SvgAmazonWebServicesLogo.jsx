...
const SvgAmazonWebServicesLogo = props => (
  <svg
    id="Amazon_Web_Services_Logo_svg__Layer_1"
    x={0}
    y={0}
    viewBox="0 0 304 182"
    xmlSpace="preserve"
  ...
  >
    <style>
      {
        ".Amazon_Web_Services_Logo_svg__st1{fill-rule:evenodd;clip-rule:evenodd;fill:#f90}"
      }
    </style>
    <path
    ...
    />
    <path
      className="Amazon_Web_Services_Logo_svg__st1"
...
export default SvgAmazonWebServicesLogo;
